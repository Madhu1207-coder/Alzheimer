...
export const modelPerformanceResults = {
  mriCNN: {
    ...
    classificationReport: {
      metrics: [
        { className: 'Normal', precision: 0.94, recall: 0.93, f1Score: 0.935, support: 172 },
        { className: 'MCI', precision: 0.96, recall: 1.0000, f1Score: 0.98, support: 15 },
        { className: 'Mild AD', precision: 0.94, recall: 0.95, f1Score: 0.945, support: 634 },
        { className: 'Moderate AD', precision: 0.93, recall: 0.94, f1Score: 0.935, support: 459 }
      ],
      overallAccuracy: 0.942,
      macroAvg: { precision: 0.94, recall: 0.95, f1Score: 0.945 },
      weightedAvg: { precision: 0.94, recall: 0.94, f1Score: 0.942 }
    }
  },
  genomicXGB: {
  ...
  ensemble: {
    ...
    description: 'Logistic Regression meta-learner combining multiple modalities',
    classificationReport: {
      metrics: [
        { className: 'Normal', precision: 0.95, recall: 0.94, f1Score: 0.945, support: 171 },
        { className: 'MCI', precision: 1.0000, recall: 1.0000, f1Score: 1.0000, support: 15 },
        { className: 'Mild AD', precision: 0.94, recall: 0.95, f1Score: 0.945, support: 629 },
        { className: 'Moderate AD', precision: 0.95, recall: 0.96, f1Score: 0.955, support: 455 }
      ],
      overallAccuracy: 0.95,
      macroAvg: { precision: 0.96, recall: 0.96, f1Score: 0.96 },
      weightedAvg: { precision: 0.95, recall: 0.95, f1Score: 0.95 }
    }
  }
}
